...
int main()
{
    ...
    std::cout << "ЗАДАНИЕ ДЛЯ ВЫПОЛНЕНИЯ:" << std::endl;
    ...
    std::cout << std::endl << "Задание 5. Решить в соответствии с вариантом задачу и результат занести в отчет:" << std::endl;
    std::cout << "1, 5, 9, 13) коммивояжера (расстояния сгенерировать случайным образом: 10 городов, расстояния 10 – 300 км, 3 расстояния между городами задать бесконечными);" << std::endl;
    ...
    std::cout << std::endl << "Задание 6. Исследовать зависимость времени вычисления необходимое для решения задачи (в соответствии с вариантом) от размерности задачи и результат в виде графика с небольшим пояснением занести в отчет:" << std::endl;
    std::cout << "1, 5, 9, 13) коммивояжера (6 – 12 городов);" << std::endl;
